...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	averageSpeed := CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift
	return averageSpeed * r.Training.Weight / MInKm * r.Training.Duration.Hours() * MinInHours
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	averageSpeed := w.Training.meanSpeed() / KmHInMsec
	heightInCm := w.Height / CmInM
	return (CaloriesWeightMultiplier*w.Weight + ((math.Pow(averageSpeed, 2))/heightInCm)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours
}
